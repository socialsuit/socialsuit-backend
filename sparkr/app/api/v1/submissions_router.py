...
from sparkr.app.models.schemas import SubmissionResponse, VerificationStatusEnum
from sparkr.app.models.models import Submission, Task, User
from sparkr.app.db.session import get_session
from sparkr.app.core.security import get_current_user
from sparkr.app.services.points import calculate_points, award_points
from sparkr.app.workers.tasks_worker import verify_submission_task
...
async def review_submission(
    ...
    if not task:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail="Task associated with this submission not found"
        )
